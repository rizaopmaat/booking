...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm text-gray-500 uppercase">{{ __('Total Available Rooms (Today)') }}</p>
                <p class="text-2xl font-bold text-gray-800">{{ $availableRoomsToday ?? 'N/A' }}</p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm text-gray-500 uppercase">{{ __('Active Bookings (Today)') }}</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="{{ route('admin.options.index') }}" class="flex items-center space-x-3 p-3 bg-gray-50 hover:bg-red-50 rounded-lg transition duration-200">
