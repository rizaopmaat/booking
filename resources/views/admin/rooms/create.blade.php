        ...
        <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" min="0" name="total_inventory" id="total_inventory" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('total_inventory') border-red-500 @enderror" value="{{ old('total_inventory') }}" required>
